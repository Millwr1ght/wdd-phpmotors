...
<body>
    ...
    <main>
        ...
        <form class="register-form" method="post" action="/phpmotors/accounts/index.php">
            ...
            <input type="text" name="clientFirstname" id="register_first_name" <?=(isset($clientFirstname) ? "value='$clientFisrtname'" : '')?> autocomplete="given-name" required> <br>
            ...
            <input type="email" name="clientEmail" id="register_email" <?=(isset($clientEmail) ? "value='$clientEmail'" : '')?> autocomplete="email" required> <br>
