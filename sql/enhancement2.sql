...
INSERT INTO TABLE client ('first_name', 'last_name', 'email', 'password', 'comment')
...
SELECT i.invModel and c.classificationName
FROM inventory i INNER JOIN carclassification
